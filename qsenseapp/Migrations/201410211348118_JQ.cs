namespace qsenseapp.Migrations
{
    ...
    public partial class JQ : DbMigration
    {
        public override void Up()
        {
            ...
            RenameTable(name: "dbo.JobExpense", newName: "JobExpenses");
            CreateTable(
                "dbo.AspNetUsers",
                c => new
                    {
            ...
            AddColumn("dbo.Activities", "User_Id", c => c.String(maxLength: 128));
            CreateIndex("dbo.Activities", "User_Id");
            AddForeignKey("dbo.Activities", "User_Id", "dbo.AspNetUsers", "Id");
        }
        ...
        public override void Down()
        {
            ...
            RenameTable(name: "dbo.JobExpenses", newName: "JobExpense");
